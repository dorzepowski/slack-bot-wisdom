...
import damiano.wisdom.MongoWordsOfWisdomFixture
import damiano.wisdom.NotFound
import damiano.wisdom.WordOfWisdom
import damiano.wisdom.WordsOfWisdom
import spock.lang.Specification

class BaseOperationsOnMongoDbWordsOfWisdomRepositorySpec extends Specification {


	MongoWordsOfWisdomFixture fixture = new MongoWordsOfWisdomFixture()

	WordsOfWisdom wordsOfWisdom = fixture.repository()
